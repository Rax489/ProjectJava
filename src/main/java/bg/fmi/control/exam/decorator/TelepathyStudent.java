...
public class TelepathyStudent extends StudentDecorator {
    public TelepathyStudent(Student student) {
        super(student);
    }
    ...
    public List<String> getSuperpowers() {
        ...
        powers.add("Телепатия");
        return powers;
    }

    @Override
    public ExamResult solve(Task task) {
        return super.solve(task).addEffect("Телепатия прихваща подсказка от първия ред", 15);
    }
}
